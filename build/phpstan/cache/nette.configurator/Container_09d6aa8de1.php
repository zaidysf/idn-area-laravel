...
class Container_09d6aa8de1 extends _PHPStan_2d0955352\Nette\DI\Container
{
	protected $tags = [
	...
	public function createService051(): PHPStan\Analyser\Ignore\IgnoredErrorHelper
	{
		return new PHPStan\Analyser\Ignore\IgnoredErrorHelper(
			$this->getService('081'),
			['#PHPDoc tag @var#', '#Unknown option "workspace" in attribute#'],
			true
		);
	}
	...
	public function createService058(): PHPStan\Analyser\ResultCache\ResultCacheManagerFactory
	{
		return new class ($this) implements PHPStan\Analyser\ResultCache\ResultCacheManagerFactory {
			...
			public function __construct(Container_09d6aa8de1 $container)
			{
	...
	public function createServiceContainer(): Container_09d6aa8de1
	{
		return $this;
	}
	...
	protected function getStaticParameters(): array
	{
		return [
			...
			'ignoreErrors' => ['#PHPDoc tag @var#', '#Unknown option "workspace" in attribute#'],
