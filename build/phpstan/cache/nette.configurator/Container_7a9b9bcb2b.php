...
class Container_7a9b9bcb2b extends _PHPStan_2d0955352\Nette\DI\Container
{
	protected $tags = [
	...
	public function createService051(): PHPStan\Analyser\Ignore\IgnoredErrorHelper
	{
		return new PHPStan\Analyser\Ignore\IgnoredErrorHelper(
			$this->getService('081'),
			['#Out of .+ possible param types, only .+ actually have it#', ['identifier' => 'missingType.iterableValue']],
			true
		);
	}
	...
	public function createService058(): PHPStan\Analyser\ResultCache\ResultCacheManagerFactory
	{
		return new class ($this) implements PHPStan\Analyser\ResultCache\ResultCacheManagerFactory {
			...
			public function __construct(Container_7a9b9bcb2b $container)
			{
	...
	public function createService0127(): PHPStan\Rules\Classes\LocalTypeAliasesCheck
	{
		return new PHPStan\Rules\Classes\LocalTypeAliasesCheck(
			['QueryBuilder' => 'Illuminate\Database\Eloquent\Builder'],
			$this->getService('reflectionProvider'),
			$this->getService('037'),
	...
	public function createServiceContainer(): Container_7a9b9bcb2b
	{
		return $this;
	}
	...
	protected function getStaticParameters(): array
	{
		return [
			...
			'ignoreErrors' => [
				'#Out of .+ possible param types, only .+ actually have it#',
			...
			'typeAliases' => ['QueryBuilder' => 'Illuminate\Database\Eloquent\Builder'],
