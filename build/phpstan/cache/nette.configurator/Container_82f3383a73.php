...
class Container_82f3383a73 extends _PHPStan_2d0955352\Nette\DI\Container
{
	protected $tags = [
	...
	public function createService058(): PHPStan\Analyser\ResultCache\ResultCacheManagerFactory
	{
		return new class ($this) implements PHPStan\Analyser\ResultCache\ResultCacheManagerFactory {
			...
			public function __construct(Container_82f3383a73 $container)
			{
	...
	public function createServiceContainer(): Container_82f3383a73
	{
		return $this;
	}
