...
class Container_8fecf41916 extends _PHPStan_2d0955352\Nette\DI\Container
{
	protected $tags = [
	...
	public function createService058(): PHPStan\Analyser\ResultCache\ResultCacheManagerFactory
	{
		return new class ($this) implements PHPStan\Analyser\ResultCache\ResultCacheManagerFactory {
			...
			public function __construct(Container_8fecf41916 $container)
			{
	...
	public function createServiceContainer(): Container_8fecf41916
	{
		return $this;
	}
